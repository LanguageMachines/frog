...
class UctoTokenizer {
 public:
  ...
  ~UctoTokenizer();
  UctoTokenizer( const UctoTokenizer& ) = delete;
  UctoTokenizer& operator=( const UctoTokenizer& ) = delete;
  ...
  std::vector<Tokenizer::Token> tokenize_data( const std::string&,
					       const std::string& = "" );
  std::vector<Tokenizer::Token> tokenize_line( const icu::UnicodeString&,
					       const std::string& = "" );
